...
C Convert branching ratios into probability distribution.
           do i=2,nr_branch_ra224
              branch_ra224(i)=branch_ra224(i)+branch_ra224(i-1)
           enddo

C Set new seed value for the random number generator.
           is=is+748
	   call rluxgo(lux,is,0,0)! Set new seed values. 
	   write(*,*)'Initialize random number generator RA224_MOMENTUM'
...
C Decay into first excited state
           ...
           energy(1)=e_alpha_ra224(2)
           energy(2)=e_gam_ra224(2)
