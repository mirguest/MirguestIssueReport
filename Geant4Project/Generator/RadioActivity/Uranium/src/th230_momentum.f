...
C Convert branching ratios into probability distribution.
           do i=2,nr_branch_th230
              branch_th230(i)=branch_th230(i)+branch_th230(i-1)
           enddo

C Set new seed value for the random number generator.
           is=is+82225
	   call rluxgo(lux,is,0,0)! Set new seed values. 
	   write(*,*)'! Initialize random number generator TH230_MOMENTUM'
...
C Decay into first excited state
           ...
           energy(1)=e_alpha_th230(2)
           energy(2)=e_gam_th230(2)
